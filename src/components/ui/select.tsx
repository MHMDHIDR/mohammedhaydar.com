...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "focus:border-lightSky bg-bodyColor flex w-full items-center justify-between rounded-md border border-white/10 px-4 py-2 text-base font-light outline-none placeholder:text-sm placeholder:text-white/40",
      className,
    )}
    {...props}
  >
