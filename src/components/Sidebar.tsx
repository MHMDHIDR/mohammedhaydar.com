...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      ref={sidebarRef}
      className={clsx(
        "border-l-hoverColor/50 dark:bg-background bg-accent-foreground fixed inset-y-0 z-100 min-h-screen max-w-96 min-w-72 transform border-l shadow-xl transition-transform duration-300 ease-in-out",
        {
